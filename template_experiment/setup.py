...
data_path = # PATH/CSV/CONTAINING/DATASET.csv 
...
X_train, y_train, X_pool, y_pool = # INITIALIZATION STATEGY 
...
exp_parameter = { 
				...
				# LIST OF TUPLES (names, path) OF DB ON WHICH THE LEARNER IS TESTED	
				  'test_db' : [('pool_init', './snapshot/init/pool.csv')],
